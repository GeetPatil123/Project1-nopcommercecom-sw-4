...
public class ElectronicsTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully(){
        ...
        registerPage.enterFirstName("Bhreina");
        registerPage.enterLastName("Patel");
        registerPage.enterEmail("Bhreinapatel");
        registerPage.enterPassword("bhreina159");
        registerPage.enterConfirmPassword("bhreina159");
